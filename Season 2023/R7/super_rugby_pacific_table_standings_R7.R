...
super_rugby_2023 = table_data %>%
  ...
  cols_width(
    ...
    Logo ~ px(50),
    Pos ~ px(35)) %>% 
  tab_header(title = md("**SUPER RUGBY PACIFIC**"), subtitle = md("Latest Standings of the 2023 Season following Round 7")) %>%
...
# Save table
new_gt_save(super_rugby_2023,"super_rugby_standings_2023_R7.png")
