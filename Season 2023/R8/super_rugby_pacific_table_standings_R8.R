...
super_rugby_2023 = table_data %>%
  ...
  cols_width(
    ...
    Logo ~ px(45),
    Pos ~ px(35)) %>% 
  tab_header(title = md("**SUPER RUGBY PACIFIC**"), subtitle = md("Standings of the 2023 Season following Round 8")) %>%
...
# Save table
new_gt_save(super_rugby_2023,"super_rugby_standings_2023_R8.png")
