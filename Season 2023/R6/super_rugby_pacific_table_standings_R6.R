...
super_rugby_2023 = table_data %>%
  ...
  cols_width(
    ...
    Logo ~ px(50),
    Pos ~ px(35)) %>% 
  tab_header(title = md("**SUPER RUGBY PACIFIC**"), subtitle = md("*2023 Season:* Standings after *Round 6*")) %>%
...
# Save table
new_gt_save(super_rugby_2023,"super_rugby_2023_R6.png")
