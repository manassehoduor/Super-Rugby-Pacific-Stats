...
super_rugby_2023 = table_data %>%
  ...
  cols_width(
    ...
    Logo ~ px(45),
    Pos ~ px(35)) %>% 
  tab_header(title = md("**SUPER RUGBY PACIFIC**"), subtitle = md("2023 Season Standings after Round 12")) %>%
  ...
  tab_source_note(
    source_note = md("**Table:** Manasseh Oduor | **Source:** super.rugby | **#SuperRugbyPacific:** @R12"))
...
# Save table
new_gt_save(super_rugby_2023,"super_rugby_standings_2023_R12.png")
